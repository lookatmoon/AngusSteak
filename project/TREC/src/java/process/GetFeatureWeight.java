...
//    HashSet<Integer> importantNegFeatureIndexes = new HashSet<Integer>();
    ...
    GetFeatureWeight(PathConfig pathConfig, String orgQuery) {
	this.pathConfig = pathConfig;
	this.orgQuery = orgQuery;

	initQueue(featureNumSelected);
	getImportantFeatureWeights(pathConfig.modelFile);
    ...
    GetFeatureWeight(PathConfig pathConfig, HashMap<String, HashSet<String>> token_to_wordSet, String orgQuery) {
	this.pathConfig = pathConfig;
	this.orgQuery = orgQuery;
