...
//			    RW.pLine(url);
	...
	String cmdPath = "/storage4/foreseer/users/raywang/annoloop/src/lg_prop/propagate.sh";
	...
	String cmdPath = "/storage4/foreseer/users/raywang/annoloop/src/lg_prop/gen_graph.sh";
	Runtime rt = Runtime.getRuntime();
