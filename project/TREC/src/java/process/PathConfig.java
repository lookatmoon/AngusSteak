...
public class PathConfig {
	...
	if(isLocal){
	    ...
	    remoteOriginalFile = "/storage4/foreseer/users/raywang/annoloop/" + queryName + "/annotate.txt";
	    evaluationFile = "/storage4/foreseer/users/lichengz/TREC/label2013/" + queryName + ".txt";
	    backupPath = "/storage4/foreseer/users/lichengz/TREC/backup/" + queryName + "/";
	    originalFile = "/storage4/foreseer/users/lichengz/TREC/data/rawdata/" + queryName + ".txt";
	    trainDataFile = "/storage4/foreseer/users/lichengz/TREC/data/train/" + queryName + "_train.txt";
	    trainInPreLoop = "/storage4/foreseer/users/lichengz/TREC/data/train/" + queryName + "_train_pre.txt";
	    testDataDir = "/storage4/foreseer/users/lichengz/TREC/data/test/" + queryName + "_test.txt";
	    parameterPath = "/storage4/foreseer/users/lichengz/TREC/data/parameters/" + queryName + ".txt";
	}
