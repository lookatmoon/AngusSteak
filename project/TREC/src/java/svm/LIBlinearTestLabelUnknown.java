...
public class LIBlinearTestLabelUnknown {
    ...
    //server
//	String LIBlinearPath = "/home/lichengz/liblinear-1.93/";
    ...
    public LIBlinearTestLabelUnknown() {
...
//		System.out.println(bestC);
    ...
    public LIBlinearTestLabelUnknown(String trainingDataFile, String testDataFile, String modelFile, String outputFile) {
...
//		System.out.println(bestC);
	...
	try {
		...
		if(testing){
		    System.out.println("By non-weighted Liblinear" + line);
		}
	...
	Runtime rt = Runtime.getRuntime();
	String[] cmd = {trainPath, "-c", bestC + "", "-e", "0.1", trainingDataFile, modelPath};
	Process p;
	try {
	    p = rt.exec(cmd);
